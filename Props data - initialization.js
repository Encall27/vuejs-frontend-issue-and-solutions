# Purpose
```
I would like to make the data initialization with props data, after on row click, the row data is passed to the pop up form. 
I have to assign the props data to local data for v-model binding. 
Since the pop up form is editDataForm, I can change the data and call the API to update it. 
```
